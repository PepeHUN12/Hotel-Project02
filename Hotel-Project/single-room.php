...
<head>
    ...
    <!-- Title -->
    <title>Schola - Hotel | Egy Személyes Szobák</title>
            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title">Egy Személyes Szobák</h2>
                        <h2 class="room-price">$100 <span>/Nap</span></h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-room-details-area mb-50">
                        ...
                        <div class="room-features-area d-flex flex-wrap mb-50">
                            ...
                            <h6>Férőhely: <span>1</span></h6>
                            <h6>Ágy: <span>Egyszemélyes</span></h6>
                        ...
                        <ul>
                            <li><i class="fa fa-check"></i> Családi Programok</li>
                            <li><i class="fa fa-check"></i> Gyerek programok</li>
                        </ul>
                    </div>
